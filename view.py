...
if st.button("Generate Code"):
    if project_description:
        ...
        crew = Crew(
            agents=[code_generation_agent, Code_opt_agent, error_resolution_agent, reporting_agent],
            tasks=[code_generation_task, Code_opt_task, error_resolution_task, reporting_task],
            verbose=True
        )
        ...
        st.write(task_output.description)
        st.write ("Summary")
        st.write(task_output.summary)
        st.write ("Output")
